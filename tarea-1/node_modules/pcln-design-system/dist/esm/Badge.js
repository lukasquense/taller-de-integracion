...
import { applyVariations, color, deprecatedColorValue, deprecatedPropType } from './utils';
...
var Badge = styled.div(_templateObject(), function (props) {
  return props.theme.fontSizes[0];
}, themeGet('letterSpacings.caps'), space, type, color, applyVariations('Badge'));
