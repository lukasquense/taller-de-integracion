...
exports.borders = exports.color = exports.getByPalette = exports.getTextColorOn = exports.hasPaletteColor = exports.getPaletteColor = exports.applyVariations = exports.getContrastRatio = exports.getLuminance = exports.decomposeColor = exports.hexToRgb = exports.deprecatedColorValue = exports.deprecatedPropType = exports.mapProps = void 0;
...
var applyVariations = function applyVariations(componentName) {
  ...
  return function (props) {
    ...
    if (variations && typeof variation === 'string') {
      return (0, _styledComponents.css)(_templateObject(), variations[variation] || '', typeof color === 'string' && (0, _styledSystem.themeGet)("componentStyles.".concat(componentName, ".").concat(variation, ".").concat(color), ''));
    }

    return (0, _styledComponents.css)(_templateObject2(), (0, _styledSystem.themeGet)("componentStyles.".concat(componentName, ".").concat(color), ''));
  };
};
/**
...
var getByPalette = function getByPalette(props) {
  return (0, _styledComponents.css)(_templateObject3(), getPaletteColor(props.bg, 'base')(props), getPaletteColor(props.color, 'base')(props));
};
/**
...
var color = function color(props) {
  if (!props.theme || !props.color && !props.bg) {
    ...
    return props.color && props.bg ? getByPalette(props) : (0, _styledComponents.css)(_templateObject4(), getPaletteColor('base')(props));
  } else if (props.color && props.bg) {
    return getByPalette(props);
  } else if (props.color && hasPaletteColor(props)) {
    return (0, _styledComponents.css)(_templateObject5(), getPaletteColor('base')(props), getTextColorOn('base')(props));
  } else if (props.color) {
    return (0, _styledComponents.css)(_templateObject6(), getPaletteColor('base')(props));
  } else {
    return (0, _styledComponents.css)(_templateObject7(), getPaletteColor(props.bg, 'base')(props));
  }
};
