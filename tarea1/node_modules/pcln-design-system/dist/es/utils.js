...
export var applyVariations = function applyVariations(componentName) {
  ...
  return function (props) {
    ...
    if (variations && typeof variation === 'string') {
      return css(_templateObject(), variations[variation] || '', typeof color === 'string' && themeGet("componentStyles.".concat(componentName, ".").concat(variation, ".").concat(color), ''));
    }

    return css(_templateObject2(), themeGet("componentStyles.".concat(componentName, ".").concat(color), ''));
  };
};
/**
...
export var getByPalette = function getByPalette(props) {
  return css(_templateObject3(), getPaletteColor(props.bg, 'base')(props), getPaletteColor(props.color, 'base')(props));
};
/**
...
export var color = function color(props) {
  if (!props.theme || !props.color && !props.bg) {
    ...
    return props.color && props.bg ? getByPalette(props) : css(_templateObject4(), getPaletteColor('base')(props));
  } else if (props.color && props.bg) {
    return getByPalette(props);
  } else if (props.color && hasPaletteColor(props)) {
    return css(_templateObject5(), getPaletteColor('base')(props), getTextColorOn('base')(props));
  } else if (props.color) {
    return css(_templateObject6(), getPaletteColor('base')(props));
  } else {
    return css(_templateObject7(), getPaletteColor(props.bg, 'base')(props));
  }
};
