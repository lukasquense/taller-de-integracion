...
import { mapProps, deprecatedPropType, applyVariations, getPaletteColor, getTextColorOn, deprecatedColorValue } from './utils';
...
var Button = mapProps(function (_ref) {
  var fullWidth = _ref.fullWidth,
      props = _objectWithoutProperties(_ref, ["fullWidth"]);

  return _objectSpread({
    width: fullWidth ? 1 : undefined,
    'aria-label': props.title
  }, props);
})(styled.button(_templateObject4(), function (props) {
