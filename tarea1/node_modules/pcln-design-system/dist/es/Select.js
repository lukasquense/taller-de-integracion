...
var ClickableIcon = styled(ChevronDown)(_templateObject());
var SelectBase = styled.select(_templateObject2(), themeGet('radius'), borders, space, fontSize);
...
SelectBase.propTypes = _objectSpread({}, space.propTypes, {}, fontSize.propTypes, {
